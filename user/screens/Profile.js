...
export default function OlyoxUserProfile() {
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            const response = await axios.get('https://www.appv2.olyox.com/api/v1/user/find-Orders-details', {
    ...
    const deleteAccount = useCallback(async (id) => {
        try {
            setLoading(true);
            const response = await axios.post(`https://www.appv2.olyox.com/api/v1/user/delete-my-account/${id}`);
